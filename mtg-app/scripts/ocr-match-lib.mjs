/**
 * Shared OCR↔dictionary matching for Node benchmarks.
 * Keep heuristics aligned with src/services/scryfallDictionaryService.ts
 */
export function normalizeAccents(s) {
  return s.normalize('NFD').replace(/[\u0300-\u036f]/g, '');
}

export function cleanOcrKey(s) {
  return (s ?? '')
    .replace(/[|\[\](){}«»<>]/g, ' ')
