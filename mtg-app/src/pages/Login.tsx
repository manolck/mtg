...
export function Login() {
  ...
  const consentRejected = searchParams.get('consent') === 'rejected';
  ...
  return (
    <div className="min-h-dvh flex items-center justify-center bg-gray-50 dark:bg-gray-900 py-10 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full surface-card p-6 sm:p-8 space-y-8">
        <div>
